programa
{
	...
	Este número está na posição XX do vetor! Você usou YY tentativas...”; onde XX 
	deve ser substituído pela posição do vetor onde se encontra o número, e YY deve
	ser substituído pelo número de vezes que o usuário tentou acertar o número. Se 
	errar em todas as tentativas, a mensagem a ser exibida é “Que pena! Você não 
	acertou...”.*/
		funcao inicio()
	{
		...
		enquanto (nao achou e tentativas <=3)
		{
			...
			se (nao achou)
			{
				...
				escreva ("Tentativa ", tentativas, " - Que número você acha que foi informado? ")
				leia (num)
				ind=0
			}
		}
